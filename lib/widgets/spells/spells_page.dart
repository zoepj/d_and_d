          ...
          children: [
            Row(
              ...
              children: [
                Column(
                  children: [
                    Text("${widget.character.spellSave}",
                ...
                Column(
                  children: [
                    Text("${widget.character.spellAttackBonus}",
                      style: const TextStyle(
                          fontWeight: FontWeight.w900,
                          fontSize: 17),),
                ...
                Column(
                  children: [
                    Text(EnumToString.convertToString(widget.character.spellcastingAbility).toUpperCase(),
                      style: const TextStyle(
                          fontWeight: FontWeight.w900,
                          fontSize: 17),),
